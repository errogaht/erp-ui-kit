...
function Catalog() {
  return <div className="site ui-kit-surface">
    <aside className="site-sidebar">
      ...
      <div className="site-sidebar-foot"><span className="site-version">v0.6.5</span><a href="https://github.com/errogaht/erp-ui-kit">GitHub ↗</a></div>
    </aside>
    <main id="top">
      ...
      <div className="site-install"><div><span className="site-kicker">START BUILDING</span><h2>Use the same system<br/>across your projects.</h2><p>Inspect the source and agent guide, then install a pinned release.</p></div><code>npm install github:errogaht/erp-ui-kit#v0.6.5</code></div>
